...
BRONZE_TABLE = "COMPLETE_DELTA_STUDYMILESTONES_BRONZE_2"
SILVER_TABLE = "COMPLETE_DELTA_STUDYMILESTONES_SILVER_2"

VOLUME = f"/Volumes/{CATALOG}/{SCHEMA}/source_data"
INBOUND = f"{VOLUME}/inbound"
METADATA = f"{VOLUME}/metadata"
SOURCE_DIRECTORY = "COMPLETE_DELTA_STUDYMILESTONES_SOURCE_2"
